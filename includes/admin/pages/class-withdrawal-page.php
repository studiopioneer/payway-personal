 ...
 *
 * Represents the admin page for handling withdrawal operations,
 * extending functionality from AbstractAdminPage.
 *
 * @author  Alex Kovalev <alex.kovalevv@gmail.com> <Telegram:@alex_kovalevv>
 * @copyright (c) 08.01.2025, CreativeMotion
 */
class WithdrawalPage extends AbstractAdminPage {

	protected function init_page_settings(): void {
		$this->page_title            = 'Вывод';
		$this->menu_title            = 'Вывод';
		$this->menu_slug             = 'payway-withdrawal';
		$this->columns               = [
			'comments' => 250,
			'status'   => 150,
			'time'     => 160,
		...
		$this->list_table_file       = 'class-withdrawal.php';
		$this->list_table_class_name = 'Withdrawal_List_Table';
		$this->db_table_name         = 'payway_withdrawal';
	}
